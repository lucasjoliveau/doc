...
inglés)](../../administration/upgrade.html#upgrade-sla) to make sure who’s
responsible for it.
...
actualizada](../../administration/upgrade.html#upgrade-request-test-database),
...
As explained on the `Odoo.sh` tab of [Obtener una base de datos de prueba
actualizada](../../administration/upgrade.html#upgrade-request-test-database),
...
nueva versión de la base de datos](../../administration/upgrade.html#upgrade-
test-your-db).

As mentioned in [Actualizar la base de datos de
producción](../../administration/upgrade.html#upgrade-upgrade-prod), both
...
producción](../../administration/upgrade.html#upgrade-upgrade-prod), depending

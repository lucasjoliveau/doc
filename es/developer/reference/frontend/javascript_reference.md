...
<p class="alert-title">
Nota</p><p>Once an asset file has been recreated, you need to refresh the page, to reload
...
<div class="alert alert-primary">
<p class="alert-title">
Nota</p><p>Native javascript modules are the primary way to define javascript code.</p>
</div>
...
<div class="alert alert-primary">
<p class="alert-title">
Nota</p><p>Note that the custom class system should be avoided for creating new code. It
...
<div class="alert alert-primary">
<p class="alert-title">
Nota</p><p>this helper method is similar to <code>Backbone.View.$</code></p>
</div>
...
pattern. We have 4 main methods:
  ...
  * _off_ : useful to remove events listener.
...
<p class="alert-title">
Advertencia</p><p>the use of this event system is discouraged, we plan to replace each
...
<div class="alert alert-warning">
<p class="alert-title">
Advertencia</p><p>If a widget is destroyed, it will be detached from the main component tree
...
There are two types of notifications:
  ...
  * _warning_ : useful to display some important/urgent information. Typically most kind of (recoverable) errors in the system.
...
<div class="alert alert-primary">
<p class="alert-title">
Nota</p><p>The JS code for the views has been designed to be usable outside of the
...
<div class="alert alert-warning">
<p class="alert-title">
Advertencia</p><p>It has to be specified on the field by which records are sorted.</p>
</div> <div class="alert alert-warning">
<p class="alert-title">
Advertencia</p><p>Having more than one field with a handle widget on the same list is not supported.</p>
</div>
...
arbitrary model.
  ...
  * Supported field types: _char, reference_
...
<div class="alert alert-warning">
<p class="alert-title">
Advertencia</p><p>When the <code>loadControlPanel</code> is set to true, the client action will automatically get the content of a search view or a control panel view.

...
NotaUse this alert block to grab the reader’s attention about additional
information.  
---  
...
TrucoUse this alert block to inform the reader about a useful trick that
requires an action.  
---  
...
ImportanteUse this alert block to notify the reader about important
information.  
---  
...
AdvertenciaUse this alert block to require the reader to proceed with caution
with what is described in the warning.  
---  
...
PeligroUse this alert block to bring the reader’s attention to a serious
threat.  
---  
...
`code-column` |  Show a dynamic side column that can be used to display interactive tutorials or code excerpts. For example, see [Hoja de referencia de Contabilidad](../../applications/finance/accounting/get_started/cheat_sheet.html).  

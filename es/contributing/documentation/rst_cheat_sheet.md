...
<p class="alert-title">
Importante</p><p>Each document must have <b>exactly one H1 heading</b>. No less, no more.</p>
</div>
...
<p class="alert-title">
Truco</p><p>Prefer the use of autonumbered lists with <code>#.</code> for better code resilience.</p>
</div>
...
<div class="alert alert-info">
<p class="alert-title">
Truco</p><p>Add the <code>:class: o-no-modal</code> <a href="https://docutils.sourceforge.io/docs/ref/rst/directives#common-options">option</a> to an image to
...
<div class="alert alert-primary">
<p class="alert-title">
Nota</p><p>Use this alert block to grab the reader’s attention about additional information.</p>
</div>  
---  
...
<div class="alert alert-info">
<p class="alert-title">
Truco</p><p>Use this alert block to inform the reader about a useful trick that requires an action.</p>
</div>  
---  
...
`code-column` |  Show a dynamic side column that can be used to display interactive tutorials or code excerpts. For example, see [Hoja de referencia de Contabilidad](../../applications/finance/accounting/get_started/cheat_sheet).  

...
La aplicación _Servicio de asistencia_ de Odoo incluye varios reportes que
...
asistencia_ de Odoo. Para ver los distintos reportes, vaya a Servicio de
asistencia ‣ Reportes.
...
Las _horas laborables_ se calculan según el calendario de trabajo
predeterminado. Para ver o cambiar el calendario de trabajo, vaya a la
aplicación Ajustes y seleccione Empleados ‣ Horas laborables de la empresa.
...
más, haga clic en el botón Medidas y seleccione una o más opciones del menú
desplegable:
...
Para ver el número de tickets que pudieron alcanzar los objetivos del SLA y
hacer un seguimiento de la cantidad de tiempo que tomó lograrlos, haga clic en
Medidas ‣ Número de SLA exitosos y Medidas ‣ Horas laborables para llegar al
SLA.

Para ordenar estos resultados por los miembros del equipo asignados a los
tickets, seleccione Total ‣ Asignado a.

Ver también

[Acuerdos de nivel de servicio (SLA)](sla.html)
...
individual.](../../../../_images/ratings-details.png)

Truco

En la página de detalles de la calificación, seleccione la opción Visible solo
de forma interna para ocultar la calificación en el portal de clientes.
...
[Calificaciones](ratings.html)

## Visualizar y filtrar opciones

En cualquier reporte de Odoo, las opciones de visualización y filtrado varían
...
Solo puede seleccionar una medida a la vez para los gráficos, pero las tablas
dinámicas pueden incluir varias.
...
de Odoo.](../../../../_images/pivot-view1.png)

Para agregar un grupo a una fila o columna a la vista de tabla dinámica, haga
clic en el ➕ (signo más) junto a Total y luego seleccione uno de los grupos.
Para eliminar uno, haga clic en ➖ (signo menos) y desmarque la opción
apropiada.
...
Cambie a la vista de gráfico seleccionando el icono de gráfico de líneas en la
parte superior derecha de la pantalla. Para cambiar entre los diferentes
...
Tanto el _gráfico de barras_ como el _gráfico de líneas_ pueden utilizar la
opción de _vista apilada_ , esta presenta dos (o más) grupos de datos uno
encima del otro, en lugar de uno junto al otro, facilitando así la comparación
de datos.
...
de Odoo.](../../../../_images/save-filters.png)

Ver también

  * [Empezar a recibir tickets](receiving_tickets.html)

  * [Reportes de Odoo](../../../essentials/reporting.html)

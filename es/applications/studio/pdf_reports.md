...
actualización de Odoo. Para duplicar un reporte, vaya a Studio ‣ Reportes.
Coloque el cursor en la esquina superior derecha del reporte, haga clic en el
ícono de la elipsis vertical (⋮), y seleccione Duplicar.

![Duplicación de un reporte PDF](../../_images/duplicate-report.png)
...
Use Descargar la vista previa del PDF para ver como los diferentes ajustes
pueden alterar el diseño de una simple factura.
...
Tajawal es compatible con caracteres latinos y árabes.
...
Esto agrega el logo al registro de la empresa en el modelo _Empresa_ , al que
puede acceder si va a Ajustes generales ‣ Empresas ‣ Actualizar información.
...
El Lema de la empresa se muestra en el encabezado de Reportes externos. Puede
agregar varias líneas de texto.

### Detalles de la empresa

Los Detalles de la empresa se muestran en el encabezado de Reportes externos.
...
repórtes. Puede seleccionar A4 (21 cm x 29.7 cm) o Carta US (21.59 cm x 27.54
cm).

Truco

Puede cambiar el Formato del papel en los reportes individuales. Abra la
aplicación que contiene el reporte, luego vaya a Studio ‣ Reportes ‣
Seleccione o cree un reporte ‣ Reporte ‣ Seleccione un formato de papel.

![Ventana emergente de configuración para el diseño predeterminado de los
reportes en PDF](../../_images/default-layout.png)
...
el modelo _Empresa_ : el Nombre de la empresa, Teléfono, Corre electrónico y
Sitio web.

Truco

Para cambiar la información de la empresa, vaya a Ajustes ‣ Empresas ‣
Actualizar información.

![Ejemplo de un encabezado externo](../../_images/external-header.png)
...
Agregar para agregar o editar elementos. Los elementos están organizados en
cuatro categorías Bloque, Inline, Mesa y Columna.
...
Para establecer el ancho de un elemento selecciónelo y luego vaya a la pestaña
Opciones.
...
datos.
  ...
  * Tabla de datos: cree una tabla y, de forma dinámica, agregue una primera columna que muestre los valores del _nombre_ de los campos [Many2Many](fields.html#studio-fields-relational-fields-many2many) o [One2Many](fields.html#studio-fields-relational-fields-one2many) en su modelo.

![Ejemplo de una tabla de datos](../../_images/data-table.png)

  * Columna de campo: agregue una nueva columna a la tabla que muestra los valores de un [Campo relacionado](fields.html#studio-fields-relational-fields-related-field) al que se usa para crear la Tabla de datos.

  * Texto en la celda: agregue cualquier texto dentro de una celda de tabla existente.

  * Campo en la celda: agregue, dentro de la celda de una tabla existente, los valores de un [Campo relacionado](fields.html#studio-fields-relational-fields-related-field) al que se usa para crear la Tabla de datos.
...
En la pestaña Reporte están disponibles varias opciones de configuración.
  ...
  * Visibilidad limitada a los grupos: limíte la disponibilidad del reporte en PDF a [grupos de usuarios](../general/users/access_rights.html) específicos.
...
A continuación están algunas de las opciones más comunes:
  ...
  * Visible para: establezca para qué [grupos de usuarios](../general/users/access_rights.html) se debe mostrar el elemento.

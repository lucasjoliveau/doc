...
sitio web, mientras que el **backend** ofrece opciones adicionales y permite
la colaboración. Esta documentación se centra en el uso del backend para crear
su contenido.
...
Haga clic en Nuevo para crear un nuevo curso. Cuando aparezca la página, puede
añadir su Título del curso y una o más Etiquetas para describir su curso.
Puede añadir una imagen para ilustrar su curso pasando el ratón por encima de
la imagen de la cámara y haciendo clic en el icono de edición. Si desea seguir
editando su curso, puede usar las pestañas Contenido, Descripción, Opciones, y
Recompensas.
...
Agregar sección para dividir su curso en diferentes secciones. Haga clic en
Agregar contenido para crear contenido. Haga clic en Agregar certificación
...
aplicación [Encuestas](../marketing/surveys/create.html).

#### Pestaña de descripción

Puede añadir una breve descripción o información relacionada con su curso en
la pestaña Descripción. Aparecerá debajo del título de su curso en su sitio
web.
...
En la pestaña Opciones, hay diferentes configuraciones disponibles: Curso,
Comunicación, Derechos de acceso, y Mostrar.
...
utilice el campo Sitio web para mostrar el curso únicamente en el sitio web
seleccionado.
...
>
>     * Por invitación: si desea que solo las personas que han recibido una
> invitación puedan inscribirse a su curso. Si selecciona esta opción,
> establezca el Mensaje de inscripción que explica el proceso de inscripción
> al curso. Este mensaje aparecerá en su sitio web debajo del título del
> curso.
>
...
En la sección Recompensas, elija cuántos puntos de karma desea otorgar a sus
alumnos cuando revisen o terminen un curso.

Defina el karma necesario para Agregar reseña, Agregar comentario o Votar
sobre el curso en la sección Derechos de acceso.

Nota

Desde su curso, haga clic en el botón Contactar a los asistentes para
comunicarse con las personas inscritas en el curso.
...
Nuevo para crear un nuevo grupo. Añada el Nombre del grupo del curso, marque
la casilla Entrada de menú para permitir a los usuarios buscar por grupo de
cursos en el sitio web, y añada etiquetas en la columna Nombre de la etiqueta.
Puede personalizar colores para cada etiqueta.
...
Gestione su contenido en eLearning ‣ Cursos ‣ Contenido. Haga clic en Nuevo
para crear contenido. Añada su Título del contenido y, si lo desea, etiquetas,
luego complete la información necesaria en las diferentes pestañas.
...
pregunta en el campo nombre de la pregunta y varias respuestas al hacer clic
en Agregar una línea. Seleccione la casilla Es la respuesta correcta para
seleccionar una respuesta como correcta. También puede completar el campo
Comentario para mostrar información adicional cuando el participante elige esa
respuesta.
...
haga clic en el botón inteligente Ir al sitio web y marque la opción Publicar
que se encuentra en la esquina derecha.

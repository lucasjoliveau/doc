...
refer to the [Create a new employee](employees/new_employee.html) document,
...
If the time off type should create [Work entries](payroll/work_entries.html)
in the _Payroll_ application, select the Work Entry Type from the drop-down
list.

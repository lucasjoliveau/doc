...
[`json`](https://docs.python.org/3/library/json.html#module-json "\(in Python
v3.12\)")
...
[`time`](https://docs.python.org/3/library/time.html#module-time "\(in Python
v3.12\)")
...
Parameters
  ...
  * **engine** ([_str_](https://docs.python.org/3/library/stdtypes.html#str "\(in Python v3.12\)")) – name of the Odoo model to use for rendering, can be used to expand or customize QWeb locally (by creating a “new” qweb based on `ir.qweb` with alterations)

...
The [previous chapter](07_basicviews.html#tutorials-getting-
...
[model](04_basicmodel.html#tutorials-getting-started-04-basicmodel), set the
[model](05_securityintro.html#tutorials-getting-started-05-securityintro), add
an [action and a menu](06_firstui.html#tutorials-getting-started-06-firstui),
and [create a view](07_basicviews.html#tutorials-getting-
started-07-basicviews).

Tip: do not forget to import any new Python files in `__init__.py`, add new
data files in `__manifest.py__` or add the access rights ;-)
...
real estate agency (i.e. an Odoo user).
...
Add a buyer and a salesperson to the `estate.property` model using the two
common models mentioned above. They should be added in a new tab of the form
view, as depicted in this section’s **Goal**.

The default value for the salesperson must be the current user. The buyer
...
The `widget` attribute will be explained in detail in [a later chapter of the
training](12_sprinkles.html#tutorials-getting-started-12-sprinkles). For now,
you can try to adding and removing it and see the result ;-)
...
include it in the views. How does Odoo know which property our offer is linked
to? Well that’s part of the magic of using the Odoo framework: sometimes
...
The [next chapter](09_compute_onchange.html#tutorials-getting-

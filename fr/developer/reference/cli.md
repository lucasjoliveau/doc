...
<p class="alert-title">
Astuce</p><p>You can enable auto-completion in your shell by running</p>
...
<div class="alert alert-warning">
<p class="alert-title">
Avertissement</p><p>has no effect if <a href="#cmdoption-odoo-bin-test-enable"><code>--test-enable</code></a> is set, as tests
...
données](../../applications/websites/website/configuration/domain_names#domain-
name-web-base-url).

<div class="alert alert-warning">
<p class="alert-title">
Avertissement</p><p>proxy mode <em>must not</em> be enabled outside of a reverse proxy
scenario</p>
</div>
...
jointes](../../administration/on_premise/deploy#deploy-streaming) for web
...
<p class="alert-title">
Pour plus d'infos</p><p><a href="backend/orm#reference-orm-environment"><span class="std std-ref">Environment</span></a></p>
</div>
...
<div class="alert alert-secondary">
<p class="alert-title">
Pour plus d'infos</p><p><a href="backend/performance#reference-performance-populate"><span class="std std-ref">Database population</span></a></p>
</div>

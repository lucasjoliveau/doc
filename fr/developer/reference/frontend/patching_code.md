...
<p class="alert-title">
Avertissement</p><p><code>this._super</code> is reassigned after each patched function is called.
...
<div class="alert alert-warning">
<p class="alert-title">
Avertissement</p><p>It is impossible to patch directly the <code>constructor</code> of a class!</p>
</div>

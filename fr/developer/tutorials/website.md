...
<p class="alert-title">
Astuce</p><p>Alternatively, Konvergo ERP can be restarted <a href="../reference/cli#cmdoption-odoo-bin-u"><code>and update modules at
...
<p class="alert-title">
Avertissement</p><p>the administrator user bypasses access control, they have access to all
...
<div class="alert alert-info">
<p class="alert-title">
Astuce</p><p><a href="../reference/backend/data#reference-data"><span class="std std-ref">Data files</span></a> can be used for demo and non-demo data.
...
are [a number of basic fields](../reference/backend/orm#reference-fields-

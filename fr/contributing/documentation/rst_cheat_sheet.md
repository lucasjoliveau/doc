...
AstuceUse this alert block to inform the reader about a useful trick that
requires an action.  
---  
...
AvertissementUse this alert block to require the reader to proceed with
caution with what is described in the warning.  
---  
...
`code-column` |  Show a dynamic side column that can be used to display interactive tutorials or code excerpts. For example, see [Aide-mémoire de la comptabilité](../../applications/finance/accounting/get_started/cheat_sheet.html).  

...
<p class="alert-title">
Pour plus d'infos</p><p><a href="../../../inventory_and_mrp/inventory/warehouses_storage/inventory_valuation/inventory_valuation_config">Inventory valuation configuration</a></p>
</div>
...
<p class="alert-title">
Astuce</p><p>When the product category’s <b>Costing Method</b> is set to <b>AVCO</b>, then the
